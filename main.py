...
# --- Esecuzione PageRank ---
m = 0.15
# Nota: passiamo h esplicitamente al parametro h
...
for i in range(10):
    ...
    # Recupera URL se possibile (indice - 1 perché gli ID partono da 1 nel file .dat solitamente)
